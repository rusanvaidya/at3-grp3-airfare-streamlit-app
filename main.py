...
# Importing preprocess_input from dz_preprocessing
from src.features.dz_preprocessing import preprocess_input
...
def load_model_based_on_origin(origin_code):
    if origin_code in ["JFK", "EWR", "LGA", "PHL"]:
        model_path = "E:/UTS/36120/AT3/at3-grp3-airfare-streamlit-app-main/models/Dezhou_finalXGB.joblib"
...
if page == "Home":
    ...
    st.write(
        "This application helps you estimate airfare based on your trip details. Use the 'Airfare Prediction' section to get started.")
    st.image("https://i.pinimg.com/736x/23/fd/cb/23fdcb0e65df24eb742b0fccbbddc65b.jpg", caption="Welcome to FlyFare!",
